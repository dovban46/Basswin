...
/**
 * Enqueue Rubik for all pages.
 */
function twentynineteen_child_enqueue_fonts() {
	wp_enqueue_style(
		'twentynineteen-child-rubik',
		'https://fonts.googleapis.com/css2?family=Rubik:wght@400;500;700;900&display=swap',
		array(),
		null
	);
}
add_action( 'wp_enqueue_scripts', 'twentynineteen_child_enqueue_fonts', 20 );
